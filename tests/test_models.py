...
class KeyboardCommandTests(unittest.TestCase):
    ...
    def test_renders_teensy_protocol_lines(self) -> None:
        ...
        self.assertEqual(text.to_teensy_lines(), ("KEY:a", "KEY:SPACE", "KEY:B", "KEY:a", "KEY:SPACE", "KEY:B"))

        space = KeyboardCommand.from_mapping(19, {"kind": "key", "key": "SPACE"})
        self.assertEqual(space.to_teensy_lines(), ("KEY:SPACE",))
